namespace BuildIt.Migrations
{
    ...
    public partial class initialcreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Title = c.String(),
                        FabricType = c.String(),
                        FabricColor = c.String(),
                        FabricAmount = c.Int(nullable: false),
                        FabricUnit = c.String(),
            ...
            CreateTable(
                "dbo.ProjectInventories",
                c => new
                    {
                        ProjectInventoryId = c.Int(nullable: false, identity: true),
                        ProjectId = c.Int(nullable: false),
                        InventoryId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.ProjectInventoryId);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.ProjectInventories");
